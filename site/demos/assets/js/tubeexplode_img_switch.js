var sImgSelectors = '.post-list-item__thumbnail';
$( sImgSelectors ).each(function(i,val){
  var self = $(val);
  // insert placeholder img
  self.attr( 'src', 'http://kiddhustle.github.io/assets/images/video_thumbnail_placeholder.jpg' );
  // pixelate
...
// @include      http://uk.pornexplode.com/*
// @include      http://splash.mobstuff.com/*
// @author       You
...
// pixel images on page

function pixelateAll(){
	var sImgSelectors = '.post-list-item__thumbnail, .videos__item__thumb, .thumb img';
      var ahImgs = [].slice.call( document.querySelectorAll( sImgSelectors ) );
      ahImgs.forEach(function(val,i){
        // insert placeholder img
        //self.attr( 'src', 'http://kiddhustle.github.io/assets/images/video_thumbnail_placeholder.jpg' );
        // pixelate
        val.closePixelate([
...
window.addEventListener('load',function(e){
  window.setTimeout(pixelateAll, 1000);
  console.log('loaded');
});
